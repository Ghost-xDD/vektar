...
contract DeployBase is Script {
    ...
    function run() external {
        ...
        // Deploy HorizonVault
        HorizonVault vault = new HorizonVault(creForwarder);
        ...
        console2.log("- MAX_LTV_INCREASE_PER_UPDATE: %s bps (2%%)", vault.MAX_LTV_INCREASE_PER_UPDATE());
        ...
        console2.log("forge verify-contract %s HorizonVault --chain base-sepolia --constructor-args $(cast abi-encode \"constructor(address)\" %s)", 
            address(vault),
            creForwarder
        );
    }
