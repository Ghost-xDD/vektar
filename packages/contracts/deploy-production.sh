#!/bin/bash
# Deploy all contracts in PRODUCTION MODE (gradual LTV updates)
# MAX_LTV_INCREASE_PER_UPDATE = 200 (2%)
...
echo "=========================================="
echo "🏭 PRODUCTION MODE DEPLOYMENT"
echo "=========================================="
echo ""
echo "This deploys contracts with production-safe settings:"
echo "  - MAX_LTV_INCREASE_PER_UPDATE: 200 bps (2%, gradual)"
...
echo ""
echo "Step 2: Deploy Horizon Vault (Base Sepolia) - PRODUCTION MODE"
echo "============================================================="
echo "Using MAX_LTV_INCREASE_PER_UPDATE=200 (2%)"
echo ""
...
export MAX_LTV_INCREASE_PER_UPDATE=200
...
echo "  Base Sepolia:"
echo "    HorizonVault: $VAULT_ADDRESS"
echo "    MAX_LTV_INCREASE: 200 bps (2%, gradual updates)"
echo ""
...
echo "  3. Test with: cd ../../apps/cre-workflow && ./run-continuous.sh"
echo ""
